...
void testStdin() {
  string sFileName =
      "/home/jarodruan/taf/test/util/" + TC_Common::now2str() + ".tmp";
  ...
  cout << cgi.setCookie(cgi.getValue("cookie1"), cgi.getValue("cookie2"),
                        TC_Common::now2str());
...
TEST(TarsUtilTestcase, UT_TC_Cgi) {
  ...
  testCgiParam(
      "db=sina&bid=161423,230233,235253&cid=0,0,0&sid=224587&advid=1293&camid="
      "25420&show=ignore&url=http://bbs.fangyou.com/"
      "viewthread.php?tid=1021196&pi=sina-langshou-wzl1");
}
