...
class RPCTestPrxCallback : public tars::ServantProxyCallback {
 ...
 public:
  virtual int onDispatch(tars::ReqMessagePtr msg) {
    static ::std::string __RPCTest_all[] = {"test", "testStr"};
    pair<string*, string*> r = equal_range(__RPCTest_all, __RPCTest_all + 2,
...
class RPCTestProxy : public tars::ServantProxy {
 public:
  ...
  void async_test(RPCTestPrxCallbackPtr callback,
  ...
  void coro_test(RPCTestCoroPrxCallbackPtr callback,
                 const map<string, string>& context = TARS_CONTEXT()) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    std::map<string, string> _mStatus;
    tars_invoke_async(tars::TARSNORMAL, "test", _os, context, _mStatus,
  ...
  tars::Int32 testStr(std::string& sOut,
                      const map<string, string>& context = TARS_CONTEXT(),
                      map<string, string>* pResponseContext = NULL) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    _os.write(sOut, 1);
    std::map<string, string> _mStatus;
    shared_ptr<tars::ResponsePacket> rep =
        tars_invoke(tars::TARSNORMAL, "testStr", _os, context, _mStatus);
    if (pResponseContext) {
      pResponseContext->swap(rep->context);
    }
  ...
  void async_testStr(RPCTestPrxCallbackPtr callback,
                     const map<string, string>& context = TARS_CONTEXT()) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    std::map<string, string> _mStatus;
    tars_invoke_async(tars::TARSNORMAL, "testStr", _os, context, _mStatus,
                      callback);
  }

  void coro_testStr(RPCTestCoroPrxCallbackPtr callback,
                    const map<string, string>& context = TARS_CONTEXT()) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    std::map<string, string> _mStatus;
    tars_invoke_async(tars::TARSNORMAL, "testStr", _os, context, _mStatus,
...
class RPCTest : public tars::Servant {
 public:
  ...
  virtual tars::Int32 testStr(std::string& sOut,
 ...
 public:
  int onDispatch(tars::TarsCurrentPtr _current,
    ...
    static ::std::string __TarsTest__RPCTest_all[] = {"test", "testStr"};

    pair<string*, string*> r =
        equal_range(__TarsTest__RPCTest_all, __TarsTest__RPCTest_all + 2,
