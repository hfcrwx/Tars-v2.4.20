...
class JsonInput {
 public:
  static void readJson(tars::Bool& b, const JsonValuePtr& p,
                       bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eJsonTypeBoolean) {
      b = JsonValueBooleanPtr::dynamicCast(p)->value;
    } else if (isRequire) {
      char s[128];
      snprintf(s, sizeof(s), "read 'Bool' type mismatch, get type: %d.",
               (p.get() ? p->getType() : 0));
  ...
  static void readJson(Char& c, const JsonValuePtr& p, bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eJsonTypeNum) {
      ...
      char s[128];
      snprintf(s, sizeof(s), "read 'Char' type mismatch, get type: %d.",
               (p.get() ? p->getType() : 0));
      throw TC_Json_Exception(s);
    }
  }
  ...
  static void readJson(UInt8& n, const JsonValuePtr& p, bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eJsonTypeNum) {
      ...
      char s[128];
      snprintf(s, sizeof(s), "read 'Uint8' type mismatch, get type: %d.",
               (p.get() ? p->getType() : 0));
      throw TC_Json_Exception(s);
    }
  }
  ...
  static void readJson(Short& n, const JsonValuePtr& p, bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eJsonTypeNum) {
      ...
      char s[128];
      snprintf(s, sizeof(s), "read 'Short' type mismatch, get type: %d.",
               (p.get() ? p->getType() : 0));
      throw TC_Json_Exception(s);
    }
  }

  static void readJson(UInt16& n, const JsonValuePtr& p,
                       bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eJsonTypeNum) {
      n = (UInt16)JsonValueNumPtr::dynamicCast(p)->value;
    } else if (isRequire) {
      char s[128];
      snprintf(s, sizeof(s), "read 'Uint16' type mismatch, get type: %d.",
               (p.get() ? p->getType() : 0));
      throw TC_Json_Exception(s);
    }
  }
  ...
  static void readJson(Int32& n, const JsonValuePtr& p, bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eJsonTypeNum) {
      ...
      char s[128];
      snprintf(s, sizeof(s), "read 'Int32' type mismatch, get type: %d.",
               (p.get() ? p->getType() : 0));
      throw TC_Json_Exception(s);
    }
  }

  static void readJson(UInt32& n, const JsonValuePtr& p,
                       bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eJsonTypeNum) {
      n = (UInt32)JsonValueNumPtr::dynamicCast(p)->value;
    } else if (isRequire) {
      char s[128];
      snprintf(s, sizeof(s), "read 'UInt32' type mismatch, get type: %d.",
               (p.get() ? p->getType() : 0));
      throw TC_Json_Exception(s);
    }
  }
  ...
  static void readJson(Int64& n, const JsonValuePtr& p, bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eJsonTypeNum) {
      ...
      char s[128];
      snprintf(s, sizeof(s), "read 'Int64' type mismatch, get type: %d.",
               (p.get() ? p->getType() : 0));
      throw TC_Json_Exception(s);
    }
  }
  ...
  static void readJson(Float& n, const JsonValuePtr& p, bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eJsonTypeNum) {
      ...
      char s[128];
      snprintf(s, sizeof(s), "read 'Float' type mismatch, get type: %d.",
               (p.get() ? p->getType() : 0));
      throw TC_Json_Exception(s);
    }
  }

  static void readJson(Double& n, const JsonValuePtr& p,
                       bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eJsonTypeNum) {
      n = JsonValueNumPtr::dynamicCast(p)->value;
    } else if (isRequire) {
      char s[128];
      snprintf(s, sizeof(s), "read 'Double' type mismatch, get type: %d.",
               (p.get() ? p->getType() : 0));
      throw TC_Json_Exception(s);
    }
  }

  static void readJson(std::string& s, const JsonValuePtr& p,
                       bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eJsonTypeString) {
      s = JsonValueStringPtr::dynamicCast(p)->value;
    } else if (isRequire) {
      char s[128];
      snprintf(s, sizeof(s), "read 'string' type mismatch, get type: %d.",
               (p.get() ? p->getType() : 0));
      throw TC_Json_Exception(s);
    }
  }

  static void readJson(char* buf, const UInt32 bufLen, UInt32& readLen,
    ...
    if (NULL != p.get() && p->getType() == eJsonTypeString) {
      ...
      if ((UInt32)pString->value.size() > bufLen) {
        char s[128];
        snprintf(s, sizeof(s), "invalid char * size, size: %u",
                 (UInt32)pString->value.size());
        throw TC_Json_Exception(s);
      }
  ...
  static void readJson(std::map<string, V, Cmp, Alloc>& m,
                       const JsonValuePtr& p, bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eJsonTypeObj) {
      ...
      char s[128];
      snprintf(s, sizeof(s), "read 'map' type mismatch, get type: %d.",
               (p.get() ? p->getType() : 0));
      throw TC_Json_Exception(s);
    }
  }
  ...
  template <typename V, typename Cmp, typename Alloc>
  static void readJson(std::map<bool, V, Cmp, Alloc>& m, const JsonValuePtr& p,
                       bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eJsonTypeObj) {
      JsonValueObjPtr pObj = JsonValueObjPtr::dynamicCast(p);
      auto iter = pObj->value.begin();
  ...
  template <typename V, typename Cmp, typename Alloc>
  static void readJson(std::map<Char, V, Cmp, Alloc>& m, const JsonValuePtr& p,
                       bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eJsonTypeObj) {
      JsonValueObjPtr pObj = JsonValueObjPtr::dynamicCast(p);
      auto iter = pObj->value.begin();
  ...
  template <typename V, typename Cmp, typename Alloc>
  static void readJson(std::map<UInt8, V, Cmp, Alloc>& m, const JsonValuePtr& p,
                       bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eJsonTypeObj) {
      JsonValueObjPtr pObj = JsonValueObjPtr::dynamicCast(p);
      auto iter = pObj->value.begin();
  ...
  template <typename V, typename Cmp, typename Alloc>
  static void readJson(std::map<Short, V, Cmp, Alloc>& m, const JsonValuePtr& p,
                       bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eJsonTypeObj) {
      JsonValueObjPtr pObj = JsonValueObjPtr::dynamicCast(p);
      auto iter = pObj->value.begin();
  ...
  template <typename V, typename Cmp, typename Alloc>
  static void readJson(std::map<UInt16, V, Cmp, Alloc>& m,
                       const JsonValuePtr& p, bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eJsonTypeObj) {
      JsonValueObjPtr pObj = JsonValueObjPtr::dynamicCast(p);
      auto iter = pObj->value.begin();
  ...
  template <typename V, typename Cmp, typename Alloc>
  static void readJson(std::map<Int32, V, Cmp, Alloc>& m, const JsonValuePtr& p,
                       bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eJsonTypeObj) {
      JsonValueObjPtr pObj = JsonValueObjPtr::dynamicCast(p);
      auto iter = pObj->value.begin();
  ...
  template <typename V, typename Cmp, typename Alloc>
  static void readJson(std::map<UInt32, V, Cmp, Alloc>& m,
                       const JsonValuePtr& p, bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eJsonTypeObj) {
      JsonValueObjPtr pObj = JsonValueObjPtr::dynamicCast(p);
      auto iter = pObj->value.begin();
  ...
  template <typename V, typename Cmp, typename Alloc>
  static void readJson(std::map<Int64, V, Cmp, Alloc>& m, const JsonValuePtr& p,
                       bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eJsonTypeObj) {
      JsonValueObjPtr pObj = JsonValueObjPtr::dynamicCast(p);
      auto iter = pObj->value.begin();
  ...
  template <typename V, typename Cmp, typename Alloc>
  static void readJson(std::map<Float, V, Cmp, Alloc>& m, const JsonValuePtr& p,
                       bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eJsonTypeObj) {
      JsonValueObjPtr pObj = JsonValueObjPtr::dynamicCast(p);
      auto iter = pObj->value.begin();
  ...
  template <typename V, typename Cmp, typename Alloc>
  static void readJson(std::map<Double, V, Cmp, Alloc>& m,
                       const JsonValuePtr& p, bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eJsonTypeObj) {
      JsonValueObjPtr pObj = JsonValueObjPtr::dynamicCast(p);
      auto iter = pObj->value.begin();
  ...
  static void readJson(std::map<K, V, Cmp, Alloc>& m, const JsonValuePtr& p,
    ...
    char s[128];
    snprintf(s, sizeof(s),
             "map key is not Basic type. map key is only string|bool|num");
    throw TC_Json_Exception(s);
  }

  template <typename T, typename Alloc>
  static void readJson(std::vector<T, Alloc>& v, const JsonValuePtr& p,
                       bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eJsonTypeArray) {
      ...
      char s[128];
      snprintf(s, sizeof(s), "read 'vector' type mismatch, get type: %d.",
               (p.get() ? p->getType() : 0));
      throw TC_Json_Exception(s);
    }
  }
  ...
  /// 读取结构数组
  template <typename T>
  static void readJson(T* v, const UInt32 len, UInt32& readLen,
                       const JsonValuePtr& p, bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eJsonTypeArray) {
      JsonValueArrayPtr pArray = JsonValueArrayPtr::dynamicCast(p);
      ...
      char s[128];
      snprintf(s, sizeof(s), "read 'T *' type mismatch, get type: %d.",
               (p.get() ? p->getType() : 0));
      throw TC_Json_Exception(s);
    }
  }
  ...
  static void readJson(
      ...
      typename detail::disable_if<detail::is_convertible<T*, TarsStructBase*>,
                                  void***>::type dummy = 0) {
    Int32 n = 0;
  ...
  static void readJson(
      T& v, const JsonValuePtr& p, bool isRequire = true,
      typename detail::enable_if<detail::is_convertible<T*, TarsStructBase*>,
                                 void***>::type dummy = 0) {
    if (NULL != p.get() && p->getType() == eJsonTypeObj) {
      JsonValueObjPtr pObj = JsonValueObjPtr::dynamicCast(p);
      v.readFromJson(pObj);
...
class JsonOutput {
 public:
  ...
  static JsonValueNumPtr writeJson(Float n) { return (new JsonValueNum(n)); }
