...
class XmlInput {
 public:
  ...
  static void readXml(std::string& s, const XmlValuePtr& p,
                      bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eXmlTypeString) {
  ...
  static void readXml(char* buf, const UInt32 bufLen, UInt32& readLen,
                      const XmlValuePtr& p, bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eXmlTypeString) {
  ...
  static void readXml(std::map<string, V, Cmp, Alloc>& m, const XmlValuePtr& p,
                      bool isRequire = true) {
  ...
  template <typename V, typename Cmp, typename Alloc>
  static void readXml(std::map<bool, V, Cmp, Alloc>& m, const XmlValuePtr& p,
                      bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eXmlTypeObj) {
      XmlValueObjPtr pObj = XmlValueObjPtr::dynamicCast(p);
      map<string, XmlValuePtr>::iterator iter;
  ...
  template <typename V, typename Cmp, typename Alloc>
  static void readXml(std::map<Char, V, Cmp, Alloc>& m, const XmlValuePtr& p,
                      bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eXmlTypeObj) {
      XmlValueObjPtr pObj = XmlValueObjPtr::dynamicCast(p);
      map<string, XmlValuePtr>::iterator iter;
  ...
  template <typename V, typename Cmp, typename Alloc>
  static void readXml(std::map<UInt8, V, Cmp, Alloc>& m, const XmlValuePtr& p,
                      bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eXmlTypeObj) {
      XmlValueObjPtr pObj = XmlValueObjPtr::dynamicCast(p);
      map<string, XmlValuePtr>::iterator iter;
  ...
  template <typename V, typename Cmp, typename Alloc>
  static void readXml(std::map<Short, V, Cmp, Alloc>& m, const XmlValuePtr& p,
                      bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eXmlTypeObj) {
      XmlValueObjPtr pObj = XmlValueObjPtr::dynamicCast(p);
      map<string, XmlValuePtr>::iterator iter;
  ...
  template <typename V, typename Cmp, typename Alloc>
  static void readXml(std::map<UInt16, V, Cmp, Alloc>& m, const XmlValuePtr& p,
                      bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eXmlTypeObj) {
      XmlValueObjPtr pObj = XmlValueObjPtr::dynamicCast(p);
      map<string, XmlValuePtr>::iterator iter;
  ...
  template <typename V, typename Cmp, typename Alloc>
  static void readXml(std::map<Int32, V, Cmp, Alloc>& m, const XmlValuePtr& p,
                      bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eXmlTypeObj) {
      XmlValueObjPtr pObj = XmlValueObjPtr::dynamicCast(p);
      map<string, XmlValuePtr>::iterator iter;
  ...
  template <typename V, typename Cmp, typename Alloc>
  static void readXml(std::map<UInt32, V, Cmp, Alloc>& m, const XmlValuePtr& p,
                      bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eXmlTypeObj) {
      XmlValueObjPtr pObj = XmlValueObjPtr::dynamicCast(p);
      map<string, XmlValuePtr>::iterator iter;
  ...
  template <typename V, typename Cmp, typename Alloc>
  static void readXml(std::map<Int64, V, Cmp, Alloc>& m, const XmlValuePtr& p,
                      bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eXmlTypeObj) {
      XmlValueObjPtr pObj = XmlValueObjPtr::dynamicCast(p);
      map<string, XmlValuePtr>::iterator iter;
  ...
  template <typename V, typename Cmp, typename Alloc>
  static void readXml(std::map<Float, V, Cmp, Alloc>& m, const XmlValuePtr& p,
                      bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eXmlTypeObj) {
      XmlValueObjPtr pObj = XmlValueObjPtr::dynamicCast(p);
      map<string, XmlValuePtr>::iterator iter;
  ...
  template <typename V, typename Cmp, typename Alloc>
  static void readXml(std::map<Double, V, Cmp, Alloc>& m, const XmlValuePtr& p,
                      bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eXmlTypeObj) {
      XmlValueObjPtr pObj = XmlValueObjPtr::dynamicCast(p);
      map<string, XmlValuePtr>::iterator iter;
  ...
  static void readXml(std::map<K, V, Cmp, Alloc>& m, const XmlValuePtr& p,
                      bool isRequire = true) {
    char s[128];
    snprintf(s, sizeof(s),
  ...
  static void readXml(std::vector<T, Alloc>& v, const XmlValuePtr& p,
                      bool isRequire = true) {
  ...
  /// 读取结构数组
  template <typename T>
  static void readXml(T* v, const UInt32 len, UInt32& readLen,
                      const XmlValuePtr& p, bool isRequire = true) {
    if (NULL != p.get() && p->getType() == eXmlTypeArray) {
      XmlValueArrayPtr pArray = XmlValueArrayPtr::dynamicCast(p);
...
class XmlOutput {
 public:
  ...
  static XmlValueStringPtr writeXml(const char* buf, const UInt32 len,
                                    bool cdata = false) {
