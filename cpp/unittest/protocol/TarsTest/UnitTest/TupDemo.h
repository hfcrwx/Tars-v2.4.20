...
struct AddInt : public tars::TarsStructBase {
 public:
  static string className() { return "TarsTest.AddInt"; }
  static string MD5() { return "e1393b6da8978c827dfe83d5c359f0c2"; }
  AddInt() { resetDefautlt(); }
  void resetDefautlt() {
    adda = 0;
    addb = 0;
...
inline bool operator!=(const AddInt& l, const AddInt& r) { return !(l == r); }
...
struct Result : public tars::TarsStructBase {
 public:
  static string className() { return "TarsTest.Result"; }
  static string MD5() { return "b84e4dd5dd1d7c43dbe702512024405f"; }
  Result() { resetDefautlt(); }
  void resetDefautlt() {
    addResult = 0;
    strResult = "";
  }
...
inline bool operator!=(const Result& l, const Result& r) { return !(l == r); }
...
class TupDemoPrxCallback : public tars::ServantProxyCallback {
 public:
  ...
  virtual void callback_helloWord_exception(tars::Int32 ret) {
    throw std::runtime_error(
        "callback_helloWord_exception() override incorrect.");
  }
 ...
 public:
  virtual int onDispatch(tars::ReqMessagePtr msg) {
    static ::std::string __TupDemo_all[] = {"aAddb", "helloWord"};
    pair<string*, string*> r = equal_range(__TupDemo_all, __TupDemo_all + 2,
...
class TupDemoProxy : public tars::ServantProxy {
 public:
  ...
  tars::Int32 aAddb(const TarsTest::AddInt& addData,
                    TarsTest::Result& aAddbResult,
    ...
    shared_ptr<tars::ResponsePacket> rep =
        tars_invoke(tars::TARSNORMAL, "aAddb", _os, context, _mStatus);
    if (pResponseContext) {
  ...
  void async_aAddb(TupDemoPrxCallbackPtr callback,
                   const TarsTest::AddInt& addData,
                   const map<string, string>& context = TARS_CONTEXT()) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    _os.write(addData, 1);
    std::map<string, string> _mStatus;
    tars_invoke_async(tars::TARSNORMAL, "aAddb", _os, context, _mStatus,
                      callback);
  }

  void coro_aAddb(TupDemoCoroPrxCallbackPtr callback,
                  const TarsTest::AddInt& addData,
                  const map<string, string>& context = TARS_CONTEXT()) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    _os.write(addData, 1);
  ...
  tars::Int32 helloWord(const std::string& strIn, std::string& strOut,
                        const map<string, string>& context = TARS_CONTEXT(),
                        map<string, string>* pResponseContext = NULL) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    _os.write(strIn, 1);
    ...
    std::map<string, string> _mStatus;
    shared_ptr<tars::ResponsePacket> rep =
        tars_invoke(tars::TARSNORMAL, "helloWord", _os, context, _mStatus);
    if (pResponseContext) {
      pResponseContext->swap(rep->context);
    }
  ...
  void async_helloWord(TupDemoPrxCallbackPtr callback, const std::string& strIn,
                       const map<string, string>& context = TARS_CONTEXT()) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    _os.write(strIn, 1);
    std::map<string, string> _mStatus;
    tars_invoke_async(tars::TARSNORMAL, "helloWord", _os, context, _mStatus,
                      callback);
  }

  void coro_helloWord(TupDemoCoroPrxCallbackPtr callback,
...
class TupDemo : public tars::Servant {
 public:
  ...
  static void async_response_aAddb(tars::TarsCurrentPtr current,
                                   tars::Int32 _ret,
                                   const TarsTest::Result& aAddbResult) {
  ...
  virtual tars::Int32 helloWord(const std::string& strIn, std::string& strOut,
                                tars::TarsCurrentPtr current) = 0;
  static void async_response_helloWord(tars::TarsCurrentPtr current,
                                       tars::Int32 _ret,
 ...
 public:
  int onDispatch(tars::TarsCurrentPtr _current,
    ...
    static ::std::string __TarsTest__TupDemo_all[] = {"aAddb", "helloWord"};

    pair<string*, string*> r =
        equal_range(__TarsTest__TupDemo_all, __TarsTest__TupDemo_all + 2,
    ...
    switch (r.first - __TarsTest__TupDemo_all) {
      case 0: {
        ...
        if (_current->getRequestVersion() == TUPVERSION) {
          ...
          tars::JsonInput::readJson(aAddbResult, _jsonPtr->value["aAddbResult"],
                                    false);
        } else {
