...
class ProxyPrxCallback : public tars::ServantProxyCallback {
 public:
  ...
  virtual void callback_testProxy_exception(tars::Int32 ret) {
    throw std::runtime_error(
        "callback_testProxy_exception() override incorrect.");
  }
 ...
 public:
  virtual int onDispatch(tars::ReqMessagePtr msg) {
    static ::std::string __Proxy_all[] = {"test", "testProxy"};
    pair<string *, string *> r = equal_range(__Proxy_all, __Proxy_all + 2,
...
class ProxyProxy : public tars::ServantProxy {
 public:
  ...
  void async_test(ProxyPrxCallbackPtr callback,
  ...
  void coro_test(ProxyCoroPrxCallbackPtr callback,
                 const map<string, string> &context = TARS_CONTEXT()) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    std::map<string, string> _mStatus;
    tars_invoke_async(tars::TARSNORMAL, "test", _os, context, _mStatus,
  ...
  tars::Int32 testProxy(const std::string &sReq, std::string &sRsp,
                        const map<string, string> &context = TARS_CONTEXT(),
                        map<string, string> *pResponseContext = NULL) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    _os.write(sReq, 1);
    ...
    std::map<string, string> _mStatus;
    shared_ptr<tars::ResponsePacket> rep =
        tars_invoke(tars::TARSNORMAL, "testProxy", _os, context, _mStatus);
    if (pResponseContext) {
      pResponseContext->swap(rep->context);
    }
  ...
  void async_testProxy(ProxyPrxCallbackPtr callback, const std::string &sReq,
                       const map<string, string> &context = TARS_CONTEXT()) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    _os.write(sReq, 1);
    std::map<string, string> _mStatus;
    tars_invoke_async(tars::TARSNORMAL, "testProxy", _os, context, _mStatus,
                      callback);
  }

  void coro_testProxy(ProxyCoroPrxCallbackPtr callback, const std::string &sReq,
                      const map<string, string> &context = TARS_CONTEXT()) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    _os.write(sReq, 1);
    std::map<string, string> _mStatus;
...
class Proxy : public tars::Servant {
 public:
  ...
  static void async_response_testProxy(tars::TarsCurrentPtr current,
                                       tars::Int32 _ret,
 ...
 public:
  int onDispatch(tars::TarsCurrentPtr _current,
    ...
    static ::std::string __TarsTest__Proxy_all[] = {"test", "testProxy"};

    pair<string *, string *> r =
        equal_range(__TarsTest__Proxy_all, __TarsTest__Proxy_all + 2,
